...
export default class VolumetricFlask extends Glassware{
    ...
    constructor(scene: Phaser.Scene, x: number, y: number) {
        ...
        this.description = "VOLUMETRIC FLASK\nA volumetric flask comes in a spherical shape with a tapering neck. It's one line indicates where to measure to and it is quite accurate at measuring to one specific volume.";
